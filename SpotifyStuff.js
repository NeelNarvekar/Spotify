...
function printJason(jasonText){
    ...
    for (i = 0; i < totalTrackElements.length; i++) {
            html += "<table><tr><td width=\""+screenWidth+"\">" + k + ". " + totalTrackElements[i][0] + "</td><td width=\""+screenWidth+"\">" + totalTrackElements[i][1] + "</td><td width=\""+screenWidth+"\">" + "<audio controls><source src=\"" + totalTrackElements[i][3] + "\"/></audio></td><td width=\""+screenWidth+"\">" + "<img src=\"" + totalTrackElements[i][2] + "\"style=\"width:50px;height:50px;\"></td></tr></table><br><br>";
            k = k + 1;
    }
